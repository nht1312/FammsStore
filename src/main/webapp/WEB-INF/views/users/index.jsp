	...
	<div class="hero_area">
		...
		<section class="slider_section ">
			<div class="slider_bg_box">
				<img src="<c:url value="/assets/user/images/slider-bg.jpg"/>" alt="">
			</div>
		...
		<div class="container">
			<div class="box">
				<div class="arrival_bg_box">
					<img src="<c:url value="/assets/user/images/arrival-bg.jpg"/>"
						alt="">
				</div>
				<div class="row">
					<div class="col-md-6 ml-auto">
						...
						<p style="margin-top: 20px; margin-bottom: 30px;">New
							Arrivals’ philosophy is to create timeless silhouettes which
							bring out femininity on the spotlight with the Turkish local
							sources.Our inspirations in design always lead to the concept of
							“Slow Fashion”.“Slow Fashion” is not focused on quantity and
							deadlines but rather quality!</p>
						<a href=""> Shop Now </a>
					</div>
				</div>
			</div>
							...
							<div class="img_container">
								<div class="img-box">
									<div class="img_box-inner">
										<img src="<c:url value="/assets/user/images/client.jpg"/>"
											alt="">
									</div>
								</div>
							</div>
