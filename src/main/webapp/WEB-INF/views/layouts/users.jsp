...
<!-- Bootstrap styles -->
<link href="<c:url value="/assets/users/css/bootstrap.css" />"
	rel="stylesheet" />
<!-- Customize styles -->
<link href="<c:url value="/assets/users/style.css" />" rel="stylesheet" />
<!-- font awesome styles -->
<link
	href="<c:url value="/assets/users/font-awesome/css/font-awesome.css" />"
	rel="stylesheet">


<!-- Favicons -->
<link rel="shortcut icon"
	href="<c:url value="/assets/users/ico/favicon.ico" />">
	<decorator:head/>
</head>
<body>
	<!-- 
			...
			<div class="container">
				<div class="alignR">
					...
					<c:if test="${ empty LoginInfo }">
						...
						class="icon-shopping-cart"></span> ${ TotalQuantyCart } Sảm phẩm(s) - <span
...
-->
	...
	<div class="copyright">
		<div class="container">
			<p class="pull-right">
				<a href="#"><img src=" <c:url value="/assets/users/img/maestro.png"/>" alt="payment"></a>
                <a href="#"><img src=" <c:url value="/assets/users/img/mc.png"/>" alt="payment"></a> <a
                    href="#"><img src=" <c:url value="/assets/users/img/pp.png"/>" alt="payment"></a> <a
                    href="#"><img src=" <c:url value="/assets/users/img/visa.png"/>" alt="payment"></a> <a
                    href="#"><img src=" <c:url value="/assets/users/img/disc.png"/>" alt="payment"></a>
			</p>
	...
	<script
		src="<c:url value="/assets/users/js/jquery.easing-1.3.min.js" />"></script>
	<script
		src="<c:url value="/assets/users/js/jquery.scrollTo-1.4.3.1-min.js" />"></script>
